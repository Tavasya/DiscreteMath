...
const AdminDashboard = () => {
  ...
  const [tests, setTests] = useState(topicTests);
  ...
  const handleToggleTestAvailability = (topicIndex: number, sectionIndex: number) => {
    setTests(prevTests => {
      ...
      newTests[topicIndex] = {
        ...newTests[topicIndex],
        sections: [...newTests[topicIndex].sections]
      };
      newTests[topicIndex].sections[sectionIndex] = {
        ...newTests[topicIndex].sections[sectionIndex],
        isAvailable: !newTests[topicIndex].sections[sectionIndex].isAvailable
      };
      return newTests;
    });
  };
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <button
                          ...
                          title={section.isAvailable ? 'Lock test' : 'Unlock test'}
                        >
